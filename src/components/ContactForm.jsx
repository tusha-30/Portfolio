...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const botToken = "7338306898:AAGjGchFzcfcj1h69sFV2UMTvNqJdTSIISI"; // Replace with your actual bot token
    const telegramChatID = "1497210046"; // Replace with your actual chat ID
